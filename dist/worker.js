...
{
	if (region.aD.aa === region.aT.aa)
	{
		return 'on line ' + region.aD.aa;
	}
	return 'on lines ' + region.aD.aa + ' through ' + region.aT.aa;
}
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'contents',
						$elm$json$Json$Encode$string($.aQ)),
						_Utils_Tuple2(
						'filepath',
...
var $author$project$CodeGen$Module$toFilepath = function (_v0) {
	var options = _v0;
	return A2($elm$core$String$join, '/', options.am) + '.elm';
};
...
var $author$project$CodeGen$Declaration$fromCustomTypeDeclarationToString = function (options) {
	return A3(
		...
		A2(
			$elm$core$String$join,
			'\n    | ',
			A2($elm$core$List$map, $author$project$CodeGen$Declaration$fromCustomTypeVariantToString, options.ca)),
		A3($elm$core$String$replace, '{{name}}', options.am, 'type {{name}}\n    = {{variants}}'));
};
...
var $author$project$Util$String$toMultilineListHelper = function (options) {
	var _v0 = options.a6;
	if (!_v0.b) {
		return _Utils_ap(options.H, options.K);
	} else {
		var items = _v0;
		return options.H + (' ' + (A2(
			$elm$core$String$join,
...
var $author$project$Util$String$toMultilineList = function (options) {
	return $author$project$Util$String$toMultilineListHelper(
		{a6: options.a6, H: '[', K: ']', an: options.an});
};
...
var $author$project$Util$String$toSinglelineListHelper = function (options) {
	...
	if (!_v0.b) {
		...
		return options.H + (' ' + (A2(
			$elm$core$String$join,
			', ',
			A2($elm$core$List$map, options.an, items)) + (' ' + options.K)));
	}
};
...
var $author$project$CodeGen$Expression$fromBranchToString = function (branch) {
	return A3(
		...
		A2(
			...
			4,
			$author$project$CodeGen$Expression$toString(branch.bR)),
		A3(
			$elm$core$String$replace,
			'{{args}}',
			$elm$core$List$isEmpty(branch.bD) ? '' : (' ' + A2(
				$elm$core$String$join,
				' ',
				A2($elm$core$List$map, $author$project$CodeGen$Argument$toString, branch.bD))),
			A3($elm$core$String$replace, '{{name}}', branch.am, '{{name}}{{args}} ->\n{{expression}}')));
};
	...
	if (_v6.$ === 1) {
		return A3(
			...
			A2(
				$author$project$Util$String$indent,
				4,
				$author$project$CodeGen$Expression$toString(declaration.bR)),
			A3(
				$elm$core$String$replace,
				'{{argument}}',
				$author$project$CodeGen$Argument$toString(declaration.ap),
				'{{argument}} =\n{{expression}}'));
	} else {
	...
	while (true) {
		switch (expression.$) {
			...
			case 2:
				...
				var _v1 = options.ba;
				if (!_v1.b) {
					var $temp$expression = options.a2;
					...
					return A3(
						$elm$core$String$replace,
						'{{finalExpression}}',
						$author$project$CodeGen$Expression$toString(options.a2),
						A3(
							$elm$core$String$replace,
							'{{letExpressions}}',
							A2(
								...
								A2(
									$elm$core$String$join,
									'\n\n',
									A2($elm$core$List$map, $author$project$CodeGen$Expression$fromLetDeclarationToString, options.ba))),
							'let\n{{letExpressions}}\nin\n{{finalExpression}}'));
				}
			case 3:
				var options = expression.a;
				return A3(
					...
					A2(
						$author$project$Util$String$indent,
						4,
						$author$project$CodeGen$Expression$toString(options.bP)),
					A3(
						$elm$core$String$replace,
						'{{ifBranch}}',
						A2(
							$author$project$Util$String$indent,
							4,
							$author$project$CodeGen$Expression$toString(options.bU)),
						A3(
							$elm$core$String$replace,
							'{{condition}}',
							$author$project$CodeGen$Expression$toString(options.bI),
							'if {{condition}} then\n{{ifBranch}}\n\nelse\n{{elseBranch}}')));
			case 4:
			...
			case 7:
				...
				return $author$project$Util$String$toSinglelineList(
					{a6: expressions, an: $author$project$CodeGen$Expression$toString});
			case 8:
				var expressions = expression.a;
			...
			case 16:
				...
				return A3(
					$elm$core$String$replace,
					'{{expression}}',
					$author$project$CodeGen$Expression$toString(options.bR),
					A3(
						$elm$core$String$replace,
						'{{args}}',
						A2(
							$elm$core$String$join,
							' ',
							A2($elm$core$List$map, $author$project$CodeGen$Argument$toString, options.bD)),
						'(\\{{args}} -> {{expression}})'));
			case 17:
				var options = expression.a;
				return A3(
			...
			default:
				...
				return A3(
					...
					A3(
						$elm$core$String$replace,
						'{{value}}',
						$author$project$CodeGen$Argument$toString(options.aI),
						'case {{value}} of\n{{branches}}'));
		}
	}
};
		...
		A3(
			...
			A3(
				...
				A3(
					$elm$core$String$replace,
					'{{annotation}}',
					$author$project$CodeGen$Annotation$toString(options.aL),
					A3(
						$elm$core$String$replace,
						'{{name}}',
						options.am,
...
var $author$project$CodeGen$Declaration$fromTypeAliasDeclarationToString = function (options) {
	return A3(
		...
		A2(
			...
			4,
			$author$project$CodeGen$Annotation$toString(options.aL)),
		A3($elm$core$String$replace, '{{name}}', options.am, 'type alias {{name}} =\n{{annotation}}'));
};
	...
	return A3(
		...
		A3(
			...
			A3(
				$elm$core$String$replace,
				'{{name}}',
				A2($elm$core$String$join, '.', options.am),
...
var $author$project$CodeGen$Module$toString = function (_v0) {
	...
	return A3(
		$elm$core$String$replace,
		'{{declarations}}',
		$elm$core$List$isEmpty(options.aS) ? '' : ('\n\n\n' + A2(
			$elm$core$String$join,
			'\n\n\n',
			A2($elm$core$List$filterMap, $author$project$CodeGen$Declaration$toString, options.aS))),
		A3(
			$elm$core$String$replace,
			'{{imports}}',
			$elm$core$List$isEmpty(options.a1) ? '' : ('\n\n' + A2(
				$elm$core$String$join,
				'\n',
				A2($elm$core$List$map, $author$project$CodeGen$Import$toString, options.a1))),
			A3(
				$elm$core$String$replace,
				'{{exposing}}',
				A2($elm$core$String$join, ', ', options.as),
				A3(
					$elm$core$String$replace,
					'{{name}}',
					A2($elm$core$String$join, '.', options.am),
				...
				return _Utils_Tuple2(
					...
					options.b$(
						A2(
							...
							function (module_) {
								return {
									aQ: $author$project$CodeGen$Module$toString(module_),
									aX: $author$project$CodeGen$Module$toFilepath(module_)
								};
							},
							options.b_(flags))));
			},
...
var $author$project$CodeGen$Import$new = function (name) {
	return {ao: $elm$core$Maybe$Nothing, as: _List_Nil, am: name};
};
...
var $author$project$Commands$AddLayout$newLayoutModule = function (data) {
	var viewFunction = $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$CodeGen$Annotation$type_('{ fromMsg : Msg -> mainMsg, content : View mainMsg, model : Model } -> View mainMsg'),
			bD: _List_fromArray(
				[
					$author$project$CodeGen$Argument$new('{ fromMsg, model, content }')
				]),
			bR: $author$project$CodeGen$Expression$multilineRecord(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'title',
									...
									$author$project$CodeGen$Expression$function(
									{
										bD: _List_fromArray(
											[
												...
												A2($elm$core$String$join, '.', data.ay))
											]),
										am: 'Html.text '
									}),
	...
	var updateFunction = $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$CodeGen$Annotation$type_('Msg -> Model -> ( Model, Effect Msg )'),
			bD: _List_fromArray(
				[
					$author$project$CodeGen$Argument$new('msg'),
					$author$project$CodeGen$Argument$new('model')
				]),
			bR: $author$project$CodeGen$Expression$caseExpression(
				{
					bF: _List_fromArray(
						[
							{
							bD: _List_Nil,
							bR: $author$project$CodeGen$Expression$multilineTuple(
								_List_fromArray(
									[
					...
					aI: $author$project$CodeGen$Argument$new('msg')
				}),
			am: 'update'
		});
	var subscriptionsFunction = $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$CodeGen$Annotation$type_('Model -> Sub Msg'),
			bD: _List_fromArray(
				[
					$author$project$CodeGen$Argument$new('model')
				]),
			bR: $author$project$CodeGen$Expression$value('Sub.none'),
			am: 'subscriptions'
		});
	var settingsTypeAlias = $author$project$CodeGen$Declaration$typeAlias(
		{
			aL: $author$project$CodeGen$Annotation$record(_List_Nil),
			am: 'Settings'
		});
	...
	var layoutFunction = $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$CodeGen$Annotation$type_('Settings -> Shared.Model -> Route () -> Layout Model Msg mainMsg'),
			bD: _List_fromArray(
				[
					$author$project$CodeGen$Argument$new('settings'),
					$author$project$CodeGen$Argument$new('shared'),
					$author$project$CodeGen$Argument$new('route')
				]),
			bR: $author$project$CodeGen$Expression$multilineFunction(
				{
					bD: _List_fromArray(
						[
	...
	var initFunction = $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$CodeGen$Annotation$type_('() -> ( Model, Effect Msg )'),
			bD: _List_fromArray(
				[
	...
	return $author$project$CodeGen$Module$new(
		{
			...
			am: A2($elm$core$List$cons, 'Layouts', data.ay)
		});
};
...
var $author$project$Commands$AddPage$Data = F4(
	function (hasViewBeenCustomized, kind, url, page) {
		return {Z: hasViewBeenCustomized, a9: kind, ab: page, ag: url};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$PageFile$Internals = F2(
	function (filepath, contents) {
		return {aQ: contents, aX: filepath};
	});
...
var $author$project$PageFile$toParamsRecordAnnotation = function (_v0) {
	...
	var addConditionalCatchAllParameters = function (fields) {
		return isCatchAllRoute ? _Utils_ap(
			...
			_List_fromArray(
				[
					_Utils_Tuple2('first_', $author$project$CodeGen$Annotation$string),
					_Utils_Tuple2(
					'rest_',
		...
		return hasViewBeenCustomized ? $author$project$CodeGen$Expression$function(
			{
				bD: _List_fromArray(
					[
						$author$project$CodeGen$Expression$string(options.O)
					]),
				am: 'View.fromString'
			}) : $author$project$CodeGen$Expression$multilineRecord(
			_List_fromArray(
...
var $author$project$Commands$AddPage$newAdvancedPageModule = function (_v0) {
	var hasViewBeenCustomized = _v0.Z;
	var page = _v0.ab;
	var url = _v0.ag;
	var viewFunctionDeclaration = $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$CodeGen$Annotation$function(
				_List_fromArray(
					[
			...
			bR: A2(
				...
				{
					bR: $author$project$CodeGen$Expression$string(url),
					O: $author$project$PageFile$toModuleName(page)
				}),
			am: 'view'
		});
	...
	var msgTypeDeclaration = $author$project$CodeGen$Declaration$customType(
		{
			...
			ca: _List_fromArray(
				[
					_Utils_Tuple2('ExampleMsgReplaceMe', _List_Nil)
				])
		});
	var modelTypeDeclaration = $author$project$CodeGen$Declaration$typeAlias(
		{
			aL: $author$project$CodeGen$Annotation$multilineRecord(_List_Nil),
			am: 'Model'
		});
...
var $author$project$Commands$AddPage$newElementPageModule = function (_v0) {
	...
	var pageFunctionDeclaration = $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$PageFile$hasDynamicParameters(page) ? $author$project$CodeGen$Annotation$function(
				_List_fromArray(
					[
						$author$project$PageFile$toParamsRecordAnnotation(page),
						$author$project$CodeGen$Annotation$type_('Page Model Msg')
					])) : $author$project$CodeGen$Annotation$type_('Page Model Msg'),
			bD: $author$project$PageFile$hasDynamicParameters(page) ? _List_fromArray(
				[
	...
	var initFunctionDeclaration = $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$CodeGen$Annotation$type_('( Model, Cmd Msg )'),
			bD: _List_Nil,
			bR: $author$project$CodeGen$Expression$multilineTuple(
				_List_fromArray(
					[
...
var $author$project$Commands$AddPage$newSandboxPageModule = function (_v0) {
			...
			bR: $author$project$CodeGen$Expression$caseExpression(
				{
					bF: _List_fromArray(
						[
							{
							bD: _List_Nil,
							bR: $author$project$CodeGen$Expression$value('model'),
							am: 'ExampleMsgReplaceMe'
						}
						]),
					aI: $author$project$CodeGen$Argument$new('msg')
	...
	var initFunctionDeclaration = $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$CodeGen$Annotation$type_('Model'),
			bD: _List_Nil,
			bR: $author$project$CodeGen$Expression$record(_List_Nil),
			am: 'init'
		});
	return $author$project$CodeGen$Module$new(
		{
	...
	var staticPageFn = $author$project$PageFile$hasDynamicParameters(page) ? $author$project$CodeGen$Declaration$function(
		{
			...
			bR: A2(
				...
				hasViewBeenCustomized,
				{
					bR: $author$project$CodeGen$Expression$parens(
						A2(
							...
							A2(
								$elm$core$List$map,
								function (piece) {
									return (piece === 'ALL_') ? $author$project$CodeGen$Expression$value('String.join \"/\" (params.first_ :: params.rest_)') : (((piece !== 'NotFound_') && A2($elm$core$String$endsWith, '_', piece)) ? $author$project$CodeGen$Expression$value(
		...
		{
			aL: $author$project$CodeGen$Annotation$type_('View msg'),
			bD: _List_Nil,
			bR: A2(
				$author$project$Commands$AddPage$viewExpressionWithContent,
				hasViewBeenCustomized,
...
var $author$project$Commands$Generate$Data = F3(
	function (pages, layouts, options) {
		return {l: layouts, F: options, m: pages};
	});
...
var $author$project$PageFile$sorter = F2(
	function (_v0, _v1) {
		var page1 = _v0;
		var page2 = _v1;
		var segments2 = page2.aX;
		var segments1 = page1.aX;
...
var $author$project$LayoutFile$sorter = F2(
	function (_v0, _v1) {
		...
		return A2(
			...
			A2($elm$core$String$join, '_', list1),
			A2($elm$core$String$join, '_', list2));
	});
		...
		aS: _List_fromArray(
			[
				$author$project$CodeGen$Declaration$function(
				{
					...
					bR: $author$project$CodeGen$Expression$letIn(
						{
							a2: $author$project$CodeGen$Expression$pipeline(
								_List_fromArray(
									[
										$author$project$CodeGen$Expression$list(
										_List_fromArray(
										...
										$author$project$CodeGen$Expression$function(
										{bD: _List_Nil, am: 'String.concat'}),
										$author$project$CodeGen$Expression$function(
										{bD: _List_Nil, am: 'Url.fromString'})
									])),
							ba: _List_fromArray(
								[
									{
									aL: $elm$core$Maybe$Just($author$project$CodeGen$Annotation$string),
									ap: $author$project$CodeGen$Argument$new('protocol'),
									bR: $author$project$CodeGen$Expression$caseExpression(
										{
											bF: _List_fromArray(
												[
													{
													bD: _List_Nil,
													bR: $author$project$CodeGen$Expression$string('http://'),
													am: 'Url.Http'
												},
													{
													bD: _List_Nil,
													bR: $author$project$CodeGen$Expression$string('https://'),
													am: 'Url.Https'
												}
												]),
											aI: $author$project$CodeGen$Argument$new('url.protocol')
										})
								},
									{
									aL: $elm$core$Maybe$Just($author$project$CodeGen$Annotation$string),
									ap: $author$project$CodeGen$Argument$new('host'),
									bR: $author$project$CodeGen$Expression$value('url.host')
								},
									{
									aL: $elm$core$Maybe$Just($author$project$CodeGen$Annotation$string),
									ap: $author$project$CodeGen$Argument$new('port_'),
									bR: $author$project$CodeGen$Expression$caseExpression(
										{
											bF: _List_fromArray(
												[
													...
													{
													bD: _List_Nil,
													bR: $author$project$CodeGen$Expression$string(''),
													am: 'Nothing'
												}
												]),
											aI: $author$project$CodeGen$Argument$new('url.port_')
										})
								},
									{
									aL: $elm$core$Maybe$Just($author$project$CodeGen$Annotation$string),
									ap: $author$project$CodeGen$Argument$new('fragment'),
									bR: $author$project$CodeGen$Expression$function(
										{
											bD: _List_fromArray(
												[
													$author$project$CodeGen$Expression$string(''),
											...
											am: 'Maybe.withDefault'
										})
								}
								])
						}),
					am: 'transformToHashUrl'
				})
			]),
		as: _List_fromArray(
			['transformToHashUrl']),
...
var $author$project$LayoutFile$toModuleName = function (_v0) {
	var list = _v0;
	return 'Layouts.' + A2($elm$core$String$join, '.', list);
};
var $author$project$LayoutFile$toVariantName = function (_v0) {
	var list = _v0;
	return A2($elm$core$String$join, '_', list);
};
				...
				function (index, pathSegment) {
					return _Utils_Tuple2(
						...
						$author$project$CodeGen$Annotation$type_(
							$author$project$LayoutFile$toModuleName(
								A2($elm$core$List$take, index + 1, list)) + ('.' + options.aH)));
				});
			return $author$project$CodeGen$Annotation$record(
				A2($elm$core$List$indexedMap, toNestedLayoutRecordField, list));
		}();
...
var $author$project$LayoutFile$toLayoutTypeDeclaration = function (layouts) {
	return $elm$core$List$isEmpty(layouts) ? $author$project$CodeGen$Declaration$typeAlias(
		{
			aL: $author$project$CodeGen$Annotation$type_('Never'),
			am: 'Layout'
		}) : $author$project$CodeGen$Declaration$customType(
		{
			...
			ca: A2(
				...
				$author$project$LayoutFile$toLayoutRouteVariant(
					{aA: $elm$core$Maybe$Nothing, aH: 'Settings'}),
				layouts)
		});
};
	...
	return $author$project$CodeGen$Module$new(
		{
			aS: _List_fromArray(
				[
					$author$project$LayoutFile$toLayoutTypeDeclaration(data.l)
				]),
			as: _List_fromArray(
				['..']),
			a1: A2($elm$core$List$map, toLayoutImport, data.l),
			am: _List_fromArray(
				['Layouts'])
		});
};
			...
			aL: $author$project$CodeGen$Annotation$function(
				_List_fromArray(
					[
						...
						$author$project$CodeGen$Annotation$type_('Effect ' + options.al),
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
									'fromSharedMsg',
									$author$project$CodeGen$Expression$value('SharedSent')),
									_Utils_Tuple2(
									'fromCmd',
									$author$project$CodeGen$Expression$value('EffectSentCmd')),
									_Utils_Tuple2(
									'toCmd',
							...
							_List_fromArray(
								[
									$author$project$CodeGen$Expression$function(
									{
										bD: _List_fromArray(
											[
												$author$project$CodeGen$Expression$value(options.ai),
...
var $author$project$Commands$Generate$runWhenAuthenticatedDeclaration = $author$project$CodeGen$Declaration$function(
	{
		...
		bR: $author$project$CodeGen$Expression$letIn(
			{
				a2: $author$project$CodeGen$Expression$value('record.page'),
				ba: _List_fromArray(
					[
						{
						aL: $elm$core$Maybe$Nothing,
						ap: $author$project$CodeGen$Argument$new('record'),
						bR: $author$project$CodeGen$Expression$value('runWhenAuthenticatedWithLayout model (\\user -> { page = toTuple user, layout = Nothing })')
					}
					])
			}),
		am: 'runWhenAuthenticated'
	});
	...
	return $author$project$CodeGen$Declaration$function(
		{
			...
			bR: $author$project$CodeGen$Expression$letIn(
				{
					a2: $author$project$CodeGen$Expression$caseExpression(
						{
							bF: _List_fromArray(
								[
									{
									...
									bR: $author$project$CodeGen$Expression$value('toRecord user'),
									am: 'Auth.Action.LoadPageWithUser'
								},
									{
									bD: _List_fromArray(
										[
											$author$project$CodeGen$Argument$new('loadingView')
										]),
									bR: wrapInPageLayout(
										$author$project$CodeGen$Expression$multilineTuple(
											_List_fromArray(
												[
													$author$project$CodeGen$Expression$value('Main.Pages.Model.Loading_ loadingView'),
													$author$project$CodeGen$Expression$value('Cmd.none')
												]))),
									am: 'Auth.Action.ShowLoadingPage'
								},
									{
									bD: _List_fromArray(
										[
									...
									am: 'Auth.Action.LoadExternalUrl'
								}
								]),
							aI: $author$project$CodeGen$Argument$new('authAction')
						}),
					ba: _List_fromArray(
						[
							{
							...
							ap: $author$project$CodeGen$Argument$new('authAction'),
							bR: $author$project$CodeGen$Expression$value('Auth.onPageLoad model.shared (Route.fromUrl () model.url)')
						},
							{
							aL: $elm$core$Maybe$Just(
								$author$project$CodeGen$Annotation$type_('Effect Msg -> Cmd Msg')),
							ap: $author$project$CodeGen$Argument$new('toCmd'),
							bR: $author$project$CodeGen$Expression$multilineFunction(
								{
									bD: _List_fromArray(
										[
			...
			am: 'runWhenAuthenticatedWithLayout'
		});
}();
var $author$project$Commands$Generate$toAuthProtectedPageDeclaration = $author$project$CodeGen$Declaration$function(
	{
		aL: $author$project$CodeGen$Annotation$type_('Model -> (Auth.User -> Shared.Model -> Route params -> Page.Page model msg) -> Route params -> Maybe (Page.Page model msg)'),
		bD: _List_fromArray(
			[
				$author$project$CodeGen$Argument$new('model'),
		...
		bR: $author$project$CodeGen$Expression$caseExpression(
			{
				bF: _List_fromArray(
					[
						{
						bD: _List_Nil,
						bR: $author$project$CodeGen$Expression$value('Just (toPage user model.shared route)'),
						am: 'Auth.Action.LoadPageWithUser user'
					},
						{
						bD: _List_Nil,
						bR: $author$project$CodeGen$Expression$value('Nothing'),
						am: '_'
					}
					]),
				aI: $author$project$CodeGen$Argument$new('Auth.onPageLoad model.shared (Route.fromUrl () model.url)')
			}),
		am: 'toAuthProtectedPage'
	});
...
var $author$project$LayoutFile$toLastPartFieldName = function (_v0) {
	var list = _v0;
	var _v1 = $elm$core$List$reverse(list);
	if (!_v1.b) {
		return 'unknown';
	} else {
		var first = _v1.a;
	...
	return A3(
		...
		F2(
			function (offset, layoutFiles) {
				return A2(
					$elm$core$List$cons,
					A2($author$project$LayoutFile$dropRight, offset, list),
					layoutFiles);
			}),
		_List_Nil,
		A2(
...
var $author$project$LayoutFile$toInitBranches = function (input) {
	var toStringForComparison = function (_v4) {
		var list = _v4;
		return A2($elm$core$String$join, ':', list);
	};
	var targetVariantName = $author$project$LayoutFile$toVariantName(input.b7);
	var toExpressionNeedingToInitializeSomeLayouts = function (options) {
		var toLetExpression = function (layoutFile) {
			var lastPartFieldName = $author$project$LayoutFile$toLastPartFieldName(layoutFile);
			return {
				aL: $elm$core$Maybe$Nothing,
				ap: $author$project$CodeGen$Argument$new(
					A3($elm$core$String$replace, '{{lastPartFieldName}}', lastPartFieldName, '( {{lastPartFieldName}}LayoutModel, {{lastPartFieldName}}LayoutEffect )')),
				bR: $author$project$CodeGen$Expression$value(
					A3(
						$elm$core$String$replace,
						'{{moduleName}}',
						$author$project$LayoutFile$toModuleName(layoutFile),
						A3($elm$core$String$replace, '{{lastPartFieldName}}', lastPartFieldName, 'Layout.init ({{moduleName}}.layout settings.{{lastPartFieldName}} model.shared route) ()')))
			};
		};
			...
			var newlyInitializedLayoutModels = A2(
				...
				A2(
					...
					function () {
						...
						$author$project$LayoutFile$toList(options.b7))));
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$Maybe$withDefault,
								_List_Nil,
								A2($elm$core$Maybe$map, $author$project$LayoutFile$toList, options.L)))),
					newlyInitializedLayoutModels));
		}();
		return $author$project$CodeGen$Expression$letIn(
			{
				a2: $author$project$CodeGen$Expression$multilineTuple(
					_List_fromArray(
						[
							$author$project$CodeGen$Expression$function(
							{
								...
								am: A3($elm$core$String$replace, '{{targetVariantName}}', targetVariantName, 'Main.Layouts.Model.{{targetVariantName}}')
							}),
							toInitialCmds(options.aj)
						])),
				ba: $elm$core$List$concat(
					_List_fromArray(
						[
							_List_fromArray(
							[
								...
								ap: $author$project$CodeGen$Argument$new('route'),
								bR: $author$project$CodeGen$Expression$value('Route.fromUrl () model.url')
							}
							]),
							A2($elm$core$List$map, toLetExpression, options.aj)
						]))
			});
	};
	var targetAndParents = $author$project$LayoutFile$toListOfSelfAndParents(input.b7);
	var isSubset = F2(
	...
	var toBranchExpression = function (_v1) {
		...
		return _Utils_eq(target, existing) ? $author$project$CodeGen$Expression$multilineTuple(
			...
			{
				aj: layoutsNeedingInitialization,
				b7: target,
				L: $elm$core$Maybe$Just(weCanReuse)
			}));
	};
	var toBranch = function (options) {
		return {
			bD: _List_Nil,
			bR: toBranchExpression(
				{aV: options.av, b7: input.b7, L: options.L}),
			am: A3(
				$elm$core$String$replace,
				'{{modelVariantName}}',
				$author$project$LayoutFile$toVariantName(options.av),
				A3($elm$core$String$replace, '{{targetVariantName}}', targetVariantName, '( Layouts.{{targetVariantName}} settings, Just (Main.Layouts.Model.{{modelVariantName}} existing) )'))
		};
	};
	...
	var defaultBranch = {
		bD: _List_Nil,
		bR: toExpressionNeedingToInitializeSomeLayouts(
			{aj: targetAndParents, b7: input.b7, L: $elm$core$Maybe$Nothing}),
		am: A3($elm$core$String$replace, '{{targetVariantName}}', targetVariantName, '( Layouts.{{targetVariantName}} settings, _ )')
	};
	return _Utils_ap(
		A2(
			$elm$core$List$map,
			toBranch,
			A2($elm$core$List$filterMap, determineWhatStateCanBeReused, input.l)),
		_List_fromArray(
			[defaultBranch]));
};
var $author$project$Commands$Generate$toInitLayoutCaseExpression = function (layouts) {
	var toBranchForLayout = function (layoutFile) {
		return $author$project$LayoutFile$toInitBranches(
			{l: layouts, b7: layoutFile});
	};
	return $author$project$CodeGen$Expression$caseExpression(
		{
			bF: A2($elm$core$List$concatMap, toBranchForLayout, layouts),
			aI: $author$project$CodeGen$Argument$new('( layout, model.layout )')
		});
};
...
var $stil4m$elm_syntax$Elm$Parser$State$emptyState = {ah: _List_Nil, M: _List_Nil};
var $stil4m$elm_syntax$Elm$Syntax$File$File = F4(
	function (moduleDefinition, imports, declarations, comments) {
		return {ah: comments, aS: declarations, a1: imports, bZ: moduleDefinition};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$getComments = function (_v0) {
	var s = _v0;
	return $elm$core$List$reverse(s.ah);
};
...
var $stil4m$elm_syntax$Elm$Syntax$Range$compareLocations = F2(
	function (left, right) {
		return (_Utils_cmp(left.bn, right.bn) < 0) ? 0 : ((_Utils_cmp(left.bn, right.bn) > 0) ? 2 : A2($elm$core$Basics$compare, left.aP, right.aP));
	});
...
var $stil4m$elm_syntax$Elm$Syntax$Expression$LetBlock = F2(
	function (declarations, expression) {
		return {aS: declarations, bR: expression};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aO: col, bK: contextStack, bg: problem, bn: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bn, s.aO, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bn, s.aO, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aO: newCol, c: s.c, d: s.d, b: newOffset, bn: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{aO: 1, c: s.c, d: s.d, b: s.b + 1, bn: s.bn + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aO: s.aO + 1, c: s.c, d: s.d, b: newOffset, bn: s.bn, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aO: col, c: s0.c, d: s0.d, b: offset, bn: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bn, s.aO, s);
	};
};
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								aT: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(end),
								aD: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(start)
							});
					}),
				A2(
					$stil4m$elm_syntax$Combine$andMap,
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {aO: col, c: context, d: indent, b: offset, bn: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.aD, s.b, s.a);
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.aW));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.a3, s.b + 1, s.bn + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.a3, firstOffset, s.bn, s.aO + 1, s.a, s.d, s.c);
			var name = A3($elm$core$String$slice, s.b, s1.b, s.a);
			return A2($elm$core$Set$member, name, i.bm) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.aW)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{aW: $elm$parser$Parser$ExpectingVariable, a3: i.a3, bm: i.bm, aD: i.aD});
};
	...
	$elm$parser$Parser$variable(
		{
			...
			bm: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
			aD: $miniBill$elm_unicode$Unicode$isLower
		}));
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.bn, s.aO, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.bn, s.aO, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $stil4m$elm_syntax$Elm$Parser$State$addComment = F2(
	function (pair, _v0) {
		...
		return _Utils_update(
			s,
			{
				ah: A2($elm$core$List$cons, pair, s.ah)
			});
	});
			...
			return $stil4m$elm_syntax$Combine$withLocation(
				function (l) {
					return A2(
						...
						l.aP) ? $stil4m$elm_syntax$Combine$succeed(0) : $stil4m$elm_syntax$Combine$fail(
						'Expected higher indent than ' + $elm$core$String$fromInt(l.aP));
				});
		});
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aO: s.aO + (newOffset - s.b), c: s.c, d: s.d, b: newOffset, bn: s.bn, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bn, s.aO - (floatOffset + s.b), invalid, s.c));
		} else {
...
var $elm$parser$Parser$number = function (i) {
	return $elm$parser$Parser$Advanced$number(
		{
			aM: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingBinary, i.aM),
			aW: $elm$parser$Parser$ExpectingNumber,
			aY: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.aY),
			a$: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.a$),
			a4: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.a4),
			bY: $elm$parser$Parser$ExpectingNumber,
			bc: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingOctal, i.bc)
		});
};
		...
		return $elm$parser$Parser$number(
			{
				...
				aY: $elm$core$Maybe$Just(floatf),
				a$: $elm$core$Maybe$Just(hexf),
				a4: $elm$core$Maybe$Just(intf),
	...
	$elm$parser$Parser$variable(
		{
			...
			bm: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
			aD: $miniBill$elm_unicode$Unicode$isUpper
		}));
	...
	return $stil4m$elm_syntax$Elm$Syntax$Range$combine(
		_List_fromArray(
			[
				...
				if (!_v0.$) {
					...
					return A2(
						...
						function (_v3) {
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.P).am),
						A2(
							$elm$core$Maybe$map,
							function (_v1) {
								var value = _v1.b;
				...
				$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.P).bR)
			]));
};
var $stil4m$elm_syntax$Elm$Syntax$Signature$Signature = F2(
	function (name, typeAnnotation) {
		return {am: name, b8: typeAnnotation};
	});
	...
	function (s) {
		return $stil4m$elm_syntax$Combine$withLocation(
			function (l) {
				...
				return A2($elm$core$List$member, l.aP, known) ? $stil4m$elm_syntax$Combine$succeed(0) : $stil4m$elm_syntax$Combine$succeed(1);
			});
	});
		...
		function (location) {
			return A2(
				...
				A2(
					...
					p,
					$stil4m$elm_syntax$Combine$modifyState(
						$stil4m$elm_syntax$Elm$Parser$State$pushColumn(location.aP))));
		});
};
					...
					function (s) {
						return $stil4m$elm_syntax$Combine$withLocation(
							function (l) {
								return _Utils_eq(
									$stil4m$elm_syntax$Elm$Parser$State$expectedColumn(s),
									l.aP) ? $stil4m$elm_syntax$Combine$choice(
									_List_fromArray(
										[
											A2(
											$stil4m$elm_syntax$Combine$map,
															...
															F3(
																function (condition, ifTrue, ifFalse) {
																	return A2(
																		$stil4m$elm_syntax$Elm$Syntax$Node$Node,
																		{
																			aT: $stil4m$elm_syntax$Elm$Syntax$Node$range(ifFalse).aT,
																			aD: current.aD
																		},
										...
										F2(
											function (args, expr) {
												return A2(
													$stil4m$elm_syntax$Elm$Syntax$Node$Node,
													{
														aT: $stil4m$elm_syntax$Elm$Syntax$Node$range(expr).aT,
														aD: current.aD
													},
...
var $stil4m$elm_syntax$Elm$Syntax$Infix$Infix = F4(
	function (direction, precedence, operator, _function) {
		return {bL: direction, au: _function, bd: operator, b3: precedence};
	});
				...
				return A2(
					...
					$stil4m$elm_syntax$Elm$Syntax$Range$combine(
						_List_fromArray(
							[
								current,
								$stil4m$elm_syntax$Elm$Syntax$Node$range(inf.au)
							])),
...
var $stil4m$elm_syntax$Elm$Syntax$Type$Type = F4(
	function (documentation, name, generics, constructors) {
		return {bJ: constructors, bM: documentation, aZ: generics, am: name};
	});
var $stil4m$elm_syntax$Elm$Syntax$TypeAlias$TypeAlias = F4(
	function (documentation, name, generics, typeAnnotation) {
		return {bM: documentation, aZ: generics, am: name, b8: typeAnnotation};
	});
							...
							return A2(
								...
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
									_List_fromArray(
										[
											start,
											$stil4m$elm_syntax$Elm$Syntax$Node$range(typeAlias.b8)
										])),
								typeAlias);
						},
						A2(
...
var $stil4m$elm_syntax$Elm$Syntax$Import$Import = F3(
	function (moduleName, moduleAlias, exposingList) {
		return {y: exposingList, z: moduleAlias, A: moduleName};
	});
			...
			return A2(
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								aT: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(end),
								aD: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(start)
							});
					}),
				p);
		});
	...
	function (start, imp) {
		var allRanges = _List_fromArray(
			[
				...
				$elm$core$Maybe$Just(
				$stil4m$elm_syntax$Elm$Syntax$Node$range(imp.A)),
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.y),
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.z)
			]);
		return A2(
			$stil4m$elm_syntax$Elm$Syntax$Node$Node,
			$stil4m$elm_syntax$Elm$Syntax$Range$combine(
	...
	var createEffectModule = F3(
		function (name, whereClauses, exp) {
			return $stil4m$elm_syntax$Elm$Syntax$Module$EffectModule(
				{aq: whereClauses.aq, y: exp, A: name, aF: whereClauses.aF});
		});
	return A2(
		$stil4m$elm_syntax$Combine$andMap,
		$stil4m$elm_syntax$Elm$Parser$Node$parser($stil4m$elm_syntax$Elm$Parser$Expose$exposeDefinition),
...
var $stil4m$elm_syntax$Elm$Syntax$Module$DefaultModuleData = F2(
	function (moduleName, exposingList) {
		return {y: exposingList, A: moduleName};
	});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aO: col, bg: problem, bn: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bn, p.aO, p.bg);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aO: 1, c: _List_Nil, d: 1, b: 0, bn: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (range, comments, previousComments) {
		...
		while (true) {
			if (!comments.b) {
				...
				var _v1 = A2($elm$core$Basics$compare, commentRange.aT.bn + 1, range.aD.bn);
				switch (_v1) {
					case 1:
...
var $stil4m$elm_syntax$Elm$Processing$addDocumentation = F3(
	function (howToUpdate, declaration, file) {
		...
		if (!maybeDoc.$) {
			...
			return {
				aS: A2($elm$core$List$cons, declaration, file.aS),
				o: A2($elm$core$List$cons, previous, file.o),
				r: remaining
			};
		}
				...
				function (x) {
					return _Utils_Tuple2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							{
								bL: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
								au: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'todo'),
								bd: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, x),
								b3: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
							},
				...
				A2(
					...
					function (_v0) {
						...
						return A4(
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(infix_.bd),
							$stil4m$elm_syntax$Elm$Syntax$Node$value(infix_.bL),
							A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
				...
				switch (expression.$) {
					...
					case 15:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LetExpression(
							{
								aS: A2($stil4m$elm_syntax$Elm$Processing$visitLetDeclarations, table, letBlock.aS),
								bR: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, letBlock.bR)
							});
					case 16:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$CaseExpression(
							{
								bG: A2(
									...
									$elm$core$Tuple$mapSecond(
										$stil4m$elm_syntax$Elm$Processing$visitExpression(table)),
									caseBlock.bG),
								bR: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, caseBlock.bR)
							});
					case 17:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LambdaExpression(
							_Utils_update(
								lambda,
								{
									bR: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, lambda.bR)
								}));
					case 18:
...
var $stil4m$elm_syntax$Elm$Processing$visitFunctionDecl = F2(
	function (table, _function) {
		...
		return _Utils_update(
			_function,
			{P: newFunctionDeclaration});
	});
var $stil4m$elm_syntax$Elm$Processing$visitFunctionDeclaration = F2(
	function (table, functionDeclaration) {
		var newExpression = A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, functionDeclaration.bR);
		return _Utils_update(
			functionDeclaration,
			{bR: newExpression});
	});
...
var $stil4m$elm_syntax$Elm$Processing$attachDocumentationAndFixOperators = F3(
	function (table, declaration, context) {
		...
		switch (_v0.$) {
			...
			case 3:
				return {
					aS: A2($elm$core$List$cons, declaration, context.aS),
					o: context.o,
					r: context.r
				};
			case 4:
...
var $stil4m$elm_syntax$Elm$Processing$buildSingle = F2(
	function (moduleIndex, imp) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, imp.y);
		if (_v0.$ === 1) {
			return _List_Nil;
		} else {
			if (!_v0.a.$) {
				var _v1 = A2(
					$elm$core$Dict$get,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(imp.A),
					moduleIndex);
				if (!_v1.$) {
					var module_ = _v1.a;
				...
				if (!_v2.$) {
					...
					return A2(
						...
						function (elem) {
							return A2(
								$elm$core$List$member,
								$stil4m$elm_syntax$Elm$Syntax$Node$value(elem.bd),
								importedOperators);
						},
...
var $stil4m$elm_syntax$Elm$RawFile$imports = function (_v0) {
	var file = _v0;
	return A2($elm$core$List$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, file.a1);
};
	...
	function (rawFile, _v0) {
		...
		return $elm$core$Dict$fromList(
			A2(
				...
				function (x) {
					return _Utils_Tuple2(
						$stil4m$elm_syntax$Elm$Syntax$Node$value(x.bd),
						x);
				},
				A2(
					$elm$core$List$concatMap,
...
var $stil4m$elm_syntax$Elm$Processing$process = F2(
	function (processContext, rawFile) {
		...
		var changes = A3(
			...
			{aS: _List_Nil, o: _List_Nil, r: file.ah},
			file.aS);
		return {
			ah: $elm$core$List$concat(
				$elm$core$List$reverse(
					A2($elm$core$List$cons, changes.r, changes.o))),
			aS: $elm$core$List$reverse(changes.aS),
			a1: file.a1,
			bZ: file.bZ
		};
	});
...
var $author$project$PageFile$isAuthProtectedPage = function (_v0) {
	...
	var isElmLandPageFromFunction = function (func) {
		var functionName = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$stil4m$elm_syntax$Elm$Syntax$Node$value(func.P).am);
		if (functionName === 'page') {
			var _v2 = func.b5;
			if (!_v2.$) {
				var node = _v2.a;
				var functionTypeAnnotation = $stil4m$elm_syntax$Elm$Syntax$Node$value(
					$stil4m$elm_syntax$Elm$Syntax$Node$value(node).b8);
	...
	var isElmLandPageFromFile = function (file) {
		return A2(
			...
			A2($elm$core$List$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, file.aS));
	};
	return A2(
		$elm$core$Maybe$withDefault,
		false,
		...
		return $author$project$CodeGen$Expression$function(
			{
				...
				am: $author$project$PageFile$toModuleName(page) + '.page'
			});
	});
...
var $author$project$PageFile$fromFunctionToExpression = function (_function) {
	return $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.P).bR;
};
				...
				return A2(
					...
					A2(
						...
						A2(
							$elm$core$List$cons,
							letInBlock.bR,
							A2($elm$core$List$map, $author$project$PageFile$fromLetDeclarationToExpression, letInBlock.aS))));
			case 16:
				var caseBlock = expression.a;
				return A2(
					$elm$core$List$any,
					...
					A2(
						$elm$core$List$map,
						$stil4m$elm_syntax$Elm$Syntax$Node$value,
						A2($elm$core$List$map, $elm$core$Tuple$second, caseBlock.bG)));
			case 17:
				var lambda = expression.a;
				return A3(
					$author$project$PageFile$expressionCouldReturn,
					modulePath,
					functionName,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(lambda.bR));
			case 18:
				return false;
			case 19:
				var nodes = expression.a;
...
var $author$project$PageFile$isAdvancedElmLandPage = function (_v0) {
	...
	var isElmLandPageFromFunction = function (func) {
		...
		var expression = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$stil4m$elm_syntax$Elm$Syntax$Node$value(func.P).bR);
		...
		_List_fromArray(
			[
				$author$project$CodeGen$Expression$function(
				{
					...
					am: 'Main.Pages.Model.' + $author$project$PageFile$toVariantName(page)
				})
...
var $author$project$Commands$Generate$toInitPageCaseExpression = F2(
	function (layouts, pages) {
		...
		var toBranchForAdvancedElmLandPage = function (page) {
			...
			return $author$project$CodeGen$Expression$letIn(
				{
					a2: $author$project$CodeGen$Expression$multilineRecord(
						_List_fromArray(
							[
								_Utils_Tuple2('page', pageExpression),
								_Utils_Tuple2(
								'layout',
								$elm$core$List$isEmpty(layouts) ? $author$project$CodeGen$Expression$value('Nothing') : $author$project$CodeGen$Expression$value('Page.layout pageModel page |> Maybe.map (initLayout model)'))
							])),
					ba: _List_fromArray(
						[
							{
							...
							ap: $author$project$CodeGen$Argument$new('page'),
							bR: A2($author$project$Commands$Generate$callAdvancedPageFunction, page, 'model.url')
						},
							{
							aL: $elm$core$Maybe$Nothing,
							ap: $author$project$CodeGen$Argument$new('( pageModel, pageEffect )'),
							bR: $author$project$CodeGen$Expression$parens(
								_List_fromArray(
									[
										$author$project$CodeGen$Expression$function(
		...
		var toBranch = function (page) {
			...
			return $author$project$PageFile$hasDynamicParameters(page) ? {
				...
				bR: branchExpression,
				am: 'Route.Path.' + $author$project$PageFile$toVariantName(page)
			} : {
				bD: _List_Nil,
				bR: branchExpression,
				am: 'Route.Path.' + $author$project$PageFile$toVariantName(page)
		...
		return $author$project$CodeGen$Expression$caseExpression(
			{
				bF: A2($elm$core$List$map, toBranch, pages),
				aI: $author$project$CodeGen$Argument$new('Route.Path.fromUrl model.url')
			});
	});
...
var $author$project$Commands$Generate$toLayoutFromPageDeclaration = function (pages) {
	var toNothingBranch = function (name) {
		return {
			bD: _List_Nil,
			bR: $author$project$CodeGen$Expression$value('Nothing'),
			am: 'Main.Pages.Model.' + name
		};
	};
	var toBranch = function (page) {
		return {
			bD: $author$project$Commands$Generate$toPageModelArgs(page),
			bR: $author$project$PageFile$isAdvancedElmLandPage(page) ? ($author$project$PageFile$isAuthProtectedPage(page) ? $author$project$CodeGen$Expression$pipeline(
				_List_fromArray(
					[
	...
	return $author$project$CodeGen$Declaration$function(
		{
			aL: $author$project$CodeGen$Annotation$type_('Model -> Maybe Layouts.Layout'),
			bD: _List_fromArray(
				[
					$author$project$CodeGen$Argument$new('model')
				]),
			bR: $author$project$CodeGen$Expression$caseExpression(
				{
					bF: _Utils_ap(
						...
						A2(
							...
							toNothingBranch,
							_List_fromArray(
								['Redirecting_', 'Loading_ _']))),
					aI: $author$project$CodeGen$Argument$new('model.page')
				}),
			am: 'toLayoutFromPage'
		});
};
var $author$project$Commands$Generate$callLayoutFunction = function (layout) {
	return $author$project$CodeGen$Expression$value(
		A3(
			$elm$core$String$replace,
			'{{lastPartField}}',
...
var $author$project$Commands$Generate$toSubscriptionLayoutCaseExpression = function (layouts) {
	var toSubscriptionExpression = function (layout) {
					...
					$author$project$CodeGen$Expression$function(
					{
						bD: _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Commands$Generate$callLayoutFunction(layout)
									])),
								$author$project$CodeGen$Expression$value(
								A3(
									$elm$core$String$replace,
						...
						am: 'Layout.subscriptions'
					}),
					$author$project$CodeGen$Expression$value(
					'Sub.map Main.Layouts.Msg.' + $author$project$LayoutFile$toVariantName(layout)),
					$author$project$CodeGen$Expression$value('Sub.map LayoutSent')
				]));
	};
	var toBranchExpression = function (layout) {
		...
		if (!_v0.b) {
			...
			if (!_v0.b.b) {
				var self = _v0.a;
				return toSubscriptionExpression(layout);
			} else {
				var selfAndParentLayouts = _v0;
	...
	return $author$project$CodeGen$Expression$caseExpression(
		{
			...
			aI: $author$project$CodeGen$Argument$new('( maybeLayout, model.layout )')
		});
};
var $author$project$Commands$Generate$toPageModelMapper = function (options) {
	var routeVariantName = $author$project$PageFile$toVariantName(options.ab);
	var pageModuleName = $author$project$PageFile$toModuleName(options.ab);
	return $author$project$CodeGen$Expression$pipeline(
		_List_fromArray(
			[
				$author$project$CodeGen$Expression$function(
				{
					bD: _List_fromArray(
						[
							options.aw ? $author$project$CodeGen$Expression$parens(
							_List_fromArray(
								[
									$author$project$CodeGen$Expression$value(pageModuleName + '.page'),
									options._ ? $author$project$CodeGen$Expression$value('user model.shared') : $author$project$CodeGen$Expression$value('model.shared'),
									$author$project$PageFile$hasDynamicParameters(options.ab) ? $author$project$CodeGen$Expression$value('(Route.fromUrl params model.url)') : $author$project$CodeGen$Expression$value('(Route.fromUrl () model.url)')
								])) : ($author$project$PageFile$hasDynamicParameters(options.ab) ? $author$project$CodeGen$Expression$parens(
							_List_fromArray(
								[
									$author$project$CodeGen$Expression$value(pageModuleName + '.page'),
									options._ ? $author$project$CodeGen$Expression$value('user params') : $author$project$CodeGen$Expression$value('params')
								])) : (options._ ? $author$project$CodeGen$Expression$parens(
							_List_fromArray(
								[
				...
				$author$project$CodeGen$Expression$function(
				{
					bD: _List_fromArray(
						[
							$author$project$CodeGen$Expression$value('PageSent')
						]),
					am: options.ak
				})
			]));
			...
			return {
				...
				bR: A2(
					...
					$author$project$Commands$Generate$toPageModelMapper(
						{
							au: 'subscriptions',
							aw: isAdvancedElmLandPage,
							_: $author$project$PageFile$isAuthProtectedPage(page),
							ak: 'Sub.map',
							ab: page
						})),
				am: 'Main.Pages.Model.' + $author$project$PageFile$toVariantName(page)
				...
				_List_fromArray(
					[
						...
						[
							...
							bD: _List_Nil,
							bR: $author$project$CodeGen$Expression$value('Sub.none'),
							am: 'Main.Pages.Model.Redirecting_'
						},
							{
							bD: _List_Nil,
							bR: $author$project$CodeGen$Expression$value('Sub.none'),
							am: 'Main.Pages.Model.Loading_ _'
						}
						])
					])),
			aI: $author$project$CodeGen$Argument$new('model.page')
	...
	return $author$project$CodeGen$Expression$lambda(
		{
			...
			bR: $author$project$CodeGen$Expression$value(
				A3(
					$elm$core$String$replace,
					'{{lastPartFieldName}}',
					$author$project$LayoutFile$toLastPartFieldName(layoutOptions.U),
					A3(
						$elm$core$String$replace,
						'{{name}}',
						$author$project$LayoutFile$toVariantName(layoutOptions.ar),
...
var $author$project$Commands$Generate$toUpdateLayoutCaseExpression = function (layouts) {
	var toBranch = function (layoutOptions) {
		return {
								...
								[
									$author$project$CodeGen$Expression$function(
									{
										bD: _List_fromArray(
											[
												$author$project$CodeGen$Expression$value(
												'Main.Layouts.Msg.' + $author$project$LayoutFile$toVariantName(layoutOptions.U))
											]),
										am: 'Effect.map'
									}),
									$author$project$CodeGen$Expression$operator('>>'),
									...
									$author$project$CodeGen$Expression$function(
									{
										bD: _List_fromArray(
											[
												...
												_List_fromArray(
													[
														$author$project$Commands$Generate$callLayoutFunction(layoutOptions.U)
													])),
			...
			am: A3(
				$elm$core$String$replace,
				'{{sendingMsgName}}',
				$author$project$LayoutFile$toVariantName(layoutOptions.U),
				A3(
					$elm$core$String$replace,
					'{{name}}',
					$author$project$LayoutFile$toVariantName(layoutOptions.ar),
	...
	var toBranches = function (currentLayout) {
		return A2(
			...
			function (layout) {
				return toBranch(
					{ar: currentLayout, U: layout});
			},
			$elm$core$List$reverse(
				$author$project$LayoutFile$toListOfSelfAndParents(currentLayout)));
	};
			...
			a2: $author$project$CodeGen$Expression$caseExpression(
				{
					bF: _Utils_ap(
						...
						_List_fromArray(
							[defaultCaseBranch])),
					aI: $author$project$CodeGen$Argument$new('( toLayoutFromPage model, model.layout, msg )')
				}),
			ba: _List_fromArray(
				[
					{
	...
	return $author$project$CodeGen$Expression$caseExpression(
		{
			bF: _Utils_ap(
				...
				_List_fromArray(
					[defaultCaseBranch])),
			aI: $author$project$CodeGen$Argument$new('( msg, model.page )')
		});
};
var $author$project$Commands$Generate$toViewCaseExpression = function (layouts) {
	var toViewBranchExpression = function (layoutList) {
		if (!layoutList.b) {
			return $author$project$CodeGen$Expression$value('viewPage model');
		} else {
			var layout = layoutList.a;
			var rest = layoutList.b;
			return $author$project$CodeGen$Expression$multilineFunction(
				{
					bD: _List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$CodeGen$Expression$function(
									{
										...
										am: $author$project$LayoutFile$toModuleName(layout) + '.layout'
									})
								])),
							$author$project$CodeGen$Expression$multilineRecord(
							_List_fromArray(
					...
					bF: _Utils_ap(
						...
						_List_fromArray(
							[
								{
								bD: _List_Nil,
								bR: $author$project$CodeGen$Expression$value('viewPage model'),
								am: '_'
							}
							])),
					aI: $author$project$CodeGen$Argument$new('( toLayoutFromPage model, model.layout )')
				}),
			ba: _List_fromArray(
				[
					{
				...
				_List_fromArray(
					[
						...
						[
							{
							bD: _List_Nil,
							bR: $author$project$CodeGen$Expression$value('View.none'),
							am: 'Main.Pages.Model.Redirecting_'
						},
							{
							bD: _List_Nil,
							bR: $author$project$CodeGen$Expression$value('View.map never loadingView'),
							am: 'Main.Pages.Model.Loading_ loadingView'
						}
						])
					])),
			aI: $author$project$CodeGen$Argument$new('model.page')
	...
	return $author$project$CodeGen$Module$new(
		{
			aS: _List_fromArray(
				[
					$author$project$CodeGen$Declaration$function(
					{
						aL: $author$project$CodeGen$Annotation$type_('Program Json.Decode.Value Model Msg'),
						bD: _List_Nil,
						bR: $author$project$CodeGen$Expression$multilineFunction(
							{
								bD: _List_fromArray(
					...
					{
						aL: $author$project$CodeGen$Annotation$multilineRecord(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'key',
						...
						bR: $author$project$CodeGen$Expression$letIn(
							{
								...
								ba: _List_fromArray(
									[
										...
										ap: $author$project$CodeGen$Argument$new('flagsResult'),
										bR: $author$project$CodeGen$Expression$function(
											{
												bD: _List_fromArray(
													[
												...
												am: 'Json.Decode.decodeValue'
											})
									},
										{
										aL: $elm$core$Maybe$Nothing,
										ap: $author$project$CodeGen$Argument$new('( sharedModel, sharedEffect )'),
										bR: $author$project$CodeGen$Expression$function(
											{
												bD: _List_fromArray(
													[
										...
										{
										aL: $elm$core$Maybe$Nothing,
										ap: $author$project$CodeGen$Argument$new('{ page, layout }'),
										bR: $author$project$CodeGen$Expression$function(
											{
												bD: _List_fromArray(
													[
					...
					$elm$core$List$isEmpty(data.l) ? $author$project$CodeGen$Declaration$none : $author$project$CodeGen$Declaration$function(
					{
						aL: $author$project$CodeGen$Annotation$function(
							_List_fromArray(
								[
									...
									$author$project$CodeGen$Annotation$type_('Layouts.Layout'),
						...
						bR: $author$project$Commands$Generate$toInitLayoutCaseExpression(data.l),
						am: 'initLayout'
					}),
					$author$project$CodeGen$Declaration$function(
					{
						...
						bR: A2($author$project$Commands$Generate$toInitPageCaseExpression, data.l, data.m),
						am: 'initPageAndLayout'
					}),
						...
						bR: $author$project$CodeGen$Expression$caseExpression(
							{
								bF: _List_fromArray(
									[
										...
										bR: $author$project$CodeGen$Expression$ifElse(
											{
												bI: $author$project$CodeGen$Expression$value('Route.Path.fromUrl url == Route.Path.fromUrl model.url'),
												bP: $author$project$CodeGen$Expression$letIn(
													{
														a2: $author$project$CodeGen$Expression$multilineTuple(
															_List_fromArray(
																[
																	$author$project$CodeGen$Expression$value('{ model | url = url, page = pageModel, layout = layoutModel }'),
																	$author$project$CodeGen$Expression$value('Cmd.batch [ pageCmd, layoutCmd ]')
																])),
														ba: _List_fromArray(
															[
																{
																...
																{
																aL: $elm$core$Maybe$Nothing,
																ap: $author$project$CodeGen$Argument$new('( pageModel, pageCmd )'),
																bR: $author$project$CodeGen$Expression$value('page')
															},
																{
																aL: $elm$core$Maybe$Nothing,
																ap: $author$project$CodeGen$Argument$new('( layoutModel, layoutCmd )'),
																bR: $author$project$CodeGen$Expression$caseExpression(
																	{
																		bF: _List_fromArray(
																			[
																				...
																				bR: $author$project$CodeGen$Expression$value('( Just layoutModel_, layoutCmd_ )'),
																				am: 'Just'
																			},
																				{
																				bD: _List_Nil,
																				bR: $author$project$CodeGen$Expression$value('( Nothing, Cmd.none )'),
																				am: 'Nothing'
																			}
																			]),
																		aI: $author$project$CodeGen$Argument$new('layout')
																	})
															}
															])
													}),
												bU: $author$project$CodeGen$Expression$multilineTuple(
													_List_fromArray(
														[
															$author$project$CodeGen$Expression$value('{ model | url = url }'),
															$author$project$CodeGen$Expression$value('Cmd.none')
														]))
											}),
										am: 'UrlChanged'
												...
												a2: $author$project$CodeGen$Expression$caseExpression(
													{
																...
																bR: $author$project$CodeGen$Expression$letIn(
																	{
																		...
																		ba: _List_fromArray(
																			[
																				{
																				aL: $elm$core$Maybe$Nothing,
																				ap: $author$project$CodeGen$Argument$new('{ layout, page }'),
																				bR: $author$project$CodeGen$Expression$value('initPageAndLayout { key = model.key, shared = sharedModel, url = model.url, layout = model.layout }')
																			},
																				{
																				aL: $elm$core$Maybe$Nothing,
																				ap: $author$project$CodeGen$Argument$new('( pageModel, pageCmd )'),
														...
														aI: $author$project$CodeGen$Argument$new('oldAction /= newAction')
													}),
												ba: _List_fromArray(
													[
														{
														...
														{
														aL: $elm$core$Maybe$Nothing,
														ap: $author$project$CodeGen$Argument$new('( oldAction, newAction )'),
														bR: $author$project$CodeGen$Expression$multilineTuple(
															_List_fromArray(
																[
																	$author$project$CodeGen$Expression$value('Auth.onPageLoad model.shared (Route.fromUrl () model.url)'),
										...
										bR: $author$project$CodeGen$Expression$multilineTuple(
											_List_fromArray(
												[
													$author$project$CodeGen$Expression$value('model'),
													$author$project$CodeGen$Expression$value('cmd')
												])),
										am: 'EffectSentCmd cmd'
									}
									]),
								aI: $author$project$CodeGen$Argument$new('msg')
							}),
					...
					$author$project$CodeGen$Declaration$function(
					{
						...
						bR: $author$project$Commands$Generate$toUpdatePageCaseExpression(data.m),
						am: 'updateFromPage'
					}),
					$author$project$CodeGen$Declaration$function(
					{
						...
						bR: $author$project$Commands$Generate$toUpdateLayoutCaseExpression(data.l),
						am: 'updateFromLayout'
					}),
					$author$project$Commands$Generate$toLayoutFromPageDeclaration(data.m),
					...
					$author$project$CodeGen$Declaration$function(
					{
						...
						bR: $author$project$CodeGen$Expression$letIn(
							{
								a2: $author$project$CodeGen$Expression$multilineFunction(
									{
										bD: _List_fromArray(
											[
												$author$project$CodeGen$Expression$multilineList(
														...
														_List_fromArray(
															[
																$author$project$CodeGen$Expression$function(
																{
																	...
																	am: 'Shared.subscriptions'
																}),
																$author$project$CodeGen$Expression$value('Sub.map SharedSent')
															])),
								...
								ba: _List_fromArray(
									[
										...
										aL: $elm$core$Maybe$Just(
											$author$project$CodeGen$Annotation$type_('Sub Msg')),
										ap: $author$project$CodeGen$Argument$new('subscriptionsFromPage'),
										bR: $author$project$Commands$Generate$toSubscriptionPageCaseExpression(data.m)
									},
										{
										aL: $elm$core$Maybe$Just(
											$author$project$CodeGen$Annotation$type_('Maybe Layouts.Layout')),
										ap: $author$project$CodeGen$Argument$new('maybeLayout'),
										bR: $author$project$CodeGen$Expression$value('toLayoutFromPage model')
									},
										{
										aL: $elm$core$Maybe$Just(
											$author$project$CodeGen$Annotation$type_('Route ()')),
										...
										aL: $elm$core$Maybe$Just(
											$author$project$CodeGen$Annotation$type_('Sub Msg')),
										ap: $author$project$CodeGen$Argument$new('subscriptionsFromLayout'),
										bR: $author$project$Commands$Generate$toSubscriptionLayoutCaseExpression(data.l)
									}
									])
							}),
						am: 'subscriptions'
						...
						bR: $author$project$CodeGen$Expression$letIn(
							{
								...
								ba: _List_fromArray(
									[
										...
										aL: $elm$core$Maybe$Just(
											$author$project$CodeGen$Annotation$type_('View Msg')),
										ap: $author$project$CodeGen$Argument$new('view_'),
										bR: $author$project$CodeGen$Expression$value('toView model')
									}
									])
							}),
						am: 'view'
					...
					$author$project$CodeGen$Declaration$function(
					{
						...
						bR: $author$project$Commands$Generate$toViewCaseExpression(data.l),
						am: 'toView'
					}),
					$author$project$CodeGen$Declaration$function(
					{
						...
						bR: $author$project$Commands$Generate$toViewPageCaseExpression(data.m),
						am: 'viewPage'
					}),
					$author$project$CodeGen$Declaration$comment(
					_List_fromArray(
					...
					{ai: 'PageSent', al: 'Main.Pages.Msg.Msg', am: 'fromPageEffect'}),
					$author$project$Commands$Generate$fromEffectDeclaration(
					{ai: 'LayoutSent', al: 'Main.Layouts.Msg.Msg', am: 'fromLayoutEffect'}),
					$author$project$Commands$Generate$fromEffectDeclaration(
					{ai: 'SharedSent', al: 'Shared.Msg', am: 'fromSharedEffect'})
				]),
			as: _List_fromArray(
				['main']),
			a1: $elm$core$List$concat(
				_List_fromArray(
					[
						_List_fromArray(
						[
						...
						A2(
							...
							A2($elm$core$List$map, $author$project$LayoutFile$toList, data.l))),
						_List_fromArray(
						[
							$author$project$CodeGen$Import$new(
							_List_fromArray(
						...
						A2(
							...
							A2($elm$core$List$map, $author$project$PageFile$toList, data.m))),
						_List_fromArray(
						[
							$author$project$CodeGen$Import$new(
							_List_fromArray(
	...
	return $elm$core$List$isEmpty(layouts) ? $author$project$CodeGen$Declaration$typeAlias(
		...
		}) : $author$project$CodeGen$Declaration$customType(
		{
			...
			ca: A2(
				$elm$core$List$map,
				$author$project$LayoutFile$toLayoutRouteVariant(
					{aA: $elm$core$Maybe$Nothing, aH: 'Model'}),
				layouts)
		});
};
	...
	return $author$project$CodeGen$Module$new(
		{
			aS: _List_fromArray(
				[
					$author$project$LayoutFile$toLayoutsModelTypeDeclaration(data.l)
				]),
			as: _List_fromArray(
				['..']),
			a1: A2(
...
var $author$project$LayoutFile$toLayoutsMsgTypeDeclaration = function (layouts) {
	...
	return $elm$core$List$isEmpty(layouts) ? $author$project$CodeGen$Declaration$typeAlias(
		...
		{
			am: 'Msg',
			ca: toLayoutMsgCustomType(layouts)
		});
};
	...
	return $author$project$CodeGen$Module$new(
		{
			aS: _List_fromArray(
				[
					$author$project$LayoutFile$toLayoutsMsgTypeDeclaration(data.l)
				]),
			as: _List_fromArray(
				['..']),
			a1: A2(
			...
			_List_fromArray(
				[
					...
					[
						...
						_List_fromArray(
							[
								$author$project$CodeGen$Annotation$type_('(View Never)')
							]))
					])
				]));
	}();
	return $author$project$CodeGen$Declaration$customType(
		{am: 'Model', ca: toPageModelCustomType});
};
	...
	return $author$project$CodeGen$Module$new(
		{
			aS: _List_fromArray(
				[
					$author$project$PageFile$toPageModelTypeDeclaration(data.m)
				]),
			as: _List_fromArray(
				['Model(..)']),
			a1: $elm$core$List$concat(
	...
	return $author$project$CodeGen$Module$new(
		{
			aS: _List_fromArray(
				[
					...
					{
						am: 'Msg',
						ca: $author$project$Commands$Generate$toPageMsgCustomType(data.m)
					})
				]),
			as: _List_fromArray(
				['Msg(..)']),
									...
									$author$project$CodeGen$Expression$function(
										{
											...
											am: 'Route.Query.fromUrl'
										})),
									_Utils_Tuple2(
									'hash',
									data.F.D ? $author$project$CodeGen$Expression$pipeline(
										_List_fromArray(
											[
												$author$project$CodeGen$Expression$function(
												{
													...
													am: 'HashRouting.transformToHashUrl'
												}),
												$author$project$CodeGen$Expression$function(
												{
													bD: _List_fromArray(
...
var $author$project$PageFile$toRouteFromStringBranch = function (page) {
	...
	return {
		bD: _List_Nil,
		bR: $author$project$PageFile$hasDynamicParameters(page) ? $author$project$CodeGen$Expression$pipeline(
			_List_fromArray(
				[
					$author$project$CodeGen$Expression$multilineFunction(
					{
						bD: _List_fromArray(
							[
								...
								A2(
									$elm$core$List$concatMap,
									function (str) {
										return (str === 'ALL_') ? _List_fromArray(
											[
												_Utils_Tuple2(
												'first_',
												$author$project$CodeGen$Expression$value('first_')),
												_Utils_Tuple2(
												'rest_',
												$author$project$CodeGen$Expression$value('rest_'))
											]) : _List_fromArray(
											[
												_Utils_Tuple2(
												$author$project$Extras$String$fromPascalCaseToCamelCase(
						...
						am: $author$project$PageFile$toVariantName(page)
					}),
	...
	return $author$project$CodeGen$Expression$letIn(
		{
			a2: $author$project$CodeGen$Expression$caseExpression(
				{
					bF: A2($elm$core$List$any, $author$project$PageFile$isTopLevelCatchAllPage, pages) ? A2(
						$elm$core$List$map,
						toBranch,
						A2(
							$elm$core$List$filter,
						...
						_List_fromArray(
							[nothingBranch])),
					aI: $author$project$CodeGen$Argument$new('urlPathSegments')
				}),
			ba: _List_fromArray(
				[
					{
					aL: $elm$core$Maybe$Just(
						$author$project$CodeGen$Annotation$type_('List String')),
					ap: $author$project$CodeGen$Argument$new('urlPathSegments'),
					bR: $author$project$CodeGen$Expression$pipeline(
						_List_fromArray(
							[
...
var $author$project$Commands$Generate$toRoutePathToStringBranch = function (page) {
	return {
		...
		bR: ($author$project$PageFile$toVariantName(page) === 'Home_') ? $author$project$CodeGen$Expression$list(_List_Nil) : $author$project$CodeGen$Expression$list(
			A2(
				$elm$core$List$map,
				function (piece) {
					return (piece === 'ALL_') ? $author$project$CodeGen$Expression$value('String.join \"/\" (params.first_ :: params.rest_)') : ((piece === 'NotFound_') ? $author$project$CodeGen$Expression$string('404') : (A2($elm$core$String$endsWith, '_', piece) ? $author$project$CodeGen$Expression$value(
						'params.' + $author$project$Extras$String$fromPascalCaseToCamelCase(
							A2($elm$core$String$dropRight, 1, piece))) : $author$project$CodeGen$Expression$string(
						$author$project$Extras$String$fromPascalCaseToKebabCase(piece))));
				},
	...
	return $author$project$CodeGen$Module$new(
		{
			aS: _List_fromArray(
				[
					...
					{
						am: 'Path',
						ca: A2($elm$core$List$map, $author$project$PageFile$toRouteVariant, data.m)
					}),
					$author$project$CodeGen$Declaration$function(
					{
						aL: $author$project$CodeGen$Annotation$function(
						...
						bR: data.F.D ? $author$project$CodeGen$Expression$pipeline(
							_List_fromArray(
								[
									$author$project$CodeGen$Expression$function(
									{
					...
					$author$project$CodeGen$Declaration$function(
					{
						...
						bR: $author$project$Commands$Generate$routePathFromStringExpression(data),
						am: 'fromString'
					}),
					$author$project$CodeGen$Declaration$function(
					{
						...
						bR: $author$project$CodeGen$Expression$value('Html.Attributes.href (toString path)'),
						am: 'href'
					}),
					$author$project$CodeGen$Declaration$function(
					{
						...
						bR: $author$project$CodeGen$Expression$letIn(
							{
									...
									_List_fromArray(
										[
											...
											$author$project$CodeGen$Expression$function(
											{
												bD: _List_fromArray(
													[
														data.F.D ? $author$project$CodeGen$Expression$string('#/') : $author$project$CodeGen$Expression$string('/')
													]),
												am: 'String.append'
											})
										])),
								ba: _List_fromArray(
									[
										...
										aL: $elm$core$Maybe$Just(
											$author$project$CodeGen$Annotation$type_('List String')),
										ap: $author$project$CodeGen$Argument$new('pieces'),
										bR: $author$project$CodeGen$Expression$caseExpression(
											{
												bF: $author$project$Commands$Generate$toRoutePathToStringBranches(data.m),
												aI: $author$project$CodeGen$Argument$new('path')
											})
									}
									])
							}),
						...
						bR: $author$project$CodeGen$Expression$caseExpression(
							{
								bF: _List_fromArray(
									[
										{
										bD: _List_Nil,
										bR: $author$project$CodeGen$Expression$value('Dict.empty'),
										am: 'Nothing'
									},
										{
										bD: _List_fromArray(
										...
										bR: $author$project$CodeGen$Expression$ifElse(
											{
												bI: $author$project$CodeGen$Expression$function(
													{
														bD: _List_fromArray(
															[
												...
												bP: $author$project$CodeGen$Expression$pipeline(
													_List_fromArray(
														[
															$author$project$CodeGen$Expression$value('query'),
															$author$project$CodeGen$Expression$function(
												...
												bU: $author$project$CodeGen$Expression$value('Dict.empty')
											}),
										am: 'Just'
									}
									]),
								aI: data.F.D ? $author$project$CodeGen$Argument$new('Maybe.andThen .query (HashRouting.transformToHashUrl url)') : $author$project$CodeGen$Argument$new('url.query')
							}),
						am: 'fromUrl'
					}),
					$author$project$CodeGen$Declaration$function(
						...
						bR: $author$project$CodeGen$Expression$caseExpression(
							{
								...
								aI: $author$project$CodeGen$Argument$new('pieces')
							}),
						am: 'queryPiecesToTuple'
					}),
					$author$project$CodeGen$Declaration$function(
					{
						aL: $author$project$CodeGen$Annotation$function(
						...
						bR: $author$project$CodeGen$Expression$pipeline(
							_List_fromArray(
								[
									...
									$author$project$CodeGen$Expression$function(
									{bD: _List_Nil, am: 'Url.Builder.toQuery'})
								])),
						am: 'toString'
					}),
					$author$project$CodeGen$Declaration$function(
						...
						bR: $author$project$CodeGen$Expression$function(
							{
								...
								am: 'Url.Builder.string'
							}),
						am: 'tupleToQueryPiece'
					})
				]),
			as: _List_fromArray(
				['fromUrl', 'toString']),
...
var $author$project$Worker$main = $author$project$CodeGen$program(
	{
		b_: function (flags) {
			...
			switch (_v0) {
				case 'generate':
					return $author$project$Commands$Generate$run(flags.Y);
				case 'add-page':
					return $author$project$Commands$AddPage$run(flags.Y);
				case 'add-layout':
					return $author$project$Commands$AddLayout$run(flags.Y);
				default:
					return _List_Nil;
			}
		},
		b$: $author$project$Worker$onComplete
	});
